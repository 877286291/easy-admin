...
import top.houyuji.code.generator.core.handler.*;
import top.houyuji.code.generator.core.handler.nameconvert.DefaultNameConvert;
...
public class EntityStrategy implements ITemplate, IStrategy {
    ...
    public static class Builder extends BaseBuilder {
        ...
        /**
         * 设置主键类型,用于主键注解,类似 {@code top.houyuji.data.core.identifier.IdGenerator}
         *
         * @param idType 主键类型
         * @return this
         */
