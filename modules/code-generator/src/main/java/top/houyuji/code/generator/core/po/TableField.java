package top.houyuji.code.generator.core.po;
...
import top.houyuji.code.generator.core.handler.IColumnTypeConvertHandler;
...
public class TableField {
    ...
    public enum QueryTypeEnums {
        EQ("eq", "top.houyuji.query.annotation.Equals", "等值条件"),
        NE("ne", "top.houyuji.query.annotation.NotEquals", "不等值条件"),
        GT("gt", "top.houyuji.query.annotation.GreaterThan", "大于条件"),
        GE("ge", "top.houyuji.query.annotation.GreaterThanOrEquals", "大于等于条件"),
        LT("lt", "top.houyuji.query.annotation.LessThan", "小于条件"),
        LE("le", "top.houyuji.query.annotation.LessThanOrEquals", "小于等于条件"),
        LIKE("like", "top.houyuji.query.annotation.Like", "模糊查询"),
        ;
